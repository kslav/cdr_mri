...
args.clip_grad = 0
args.z_dim = 4
args.optimize_z = False

networks = ['ResNet', 'ResNet', 'ResNet', 'ResNet', 'DeepDecoder']
...
class TestRecon(unittest.TestCase):
    ...
    def test_recon(self):
        ...
        for i, recon in enumerate([CGSenseRecon, MoDLRecon, ResNetRecon, DeepBasisPursuitRecon, CSDIPRecon]):
            print('Testing Recon {}'.format(recon))
            args.network = networks[i]
